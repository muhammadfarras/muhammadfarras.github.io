...
1.  Selama projek inisiasi, {==nilai sistem pada sebuah organisasi bisnis==} teridentifikasi dengan ? - bagaimana sebuah sistem dapa berkontribusi terhadap kesukesan organisasi dimasa yang akan datang ? Kebanyakan ide-ide dari sistem barus sering kali berasal dari luar area IS itu sendiri dan dicatat pada `system request`. **System Request** menyajikan rangkuman singkat dari kebutuhan bisnis dan bagaimana sistem informasi memenuhi kebutuhan tersebut sehingga membuat nilai bisnis. Departemen IS berkerja sama denga orang atau organisasi yang membuat permintaan untuk menghasilkan *feasibility analysis*. Analisis kelayakan memeriksa aspek-aspek kunci dari proyek yang diusulkan:
